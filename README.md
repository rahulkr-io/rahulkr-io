...
| [**RDP Lateral Movement Detection**](https://github.com/rahulkr-io/splunk-soc-projects/Project-3_RDP-Lateral-Movement) | `T1021.001` | Identifies same-user RDP logins to multiple hosts within 5 minutes (Logon Type 10), a post-compromise lateral movement technique. |
| [**Successful Firewall Connection from Blacklisted IP (TI-based)**](https://github.com/rahulkr-io/splunk-soc-projects/Project-4_Blacklisted-IP-Firewall) |`T1071.001` `T1071.002` `T1105` | Alerts on inbound firewall connections from known malicious IPs, enriched via AbuseIPDB, Cisco Talos, and VirusTotal. |
